...
if (isset($_POST["id"])) {
    ...
    if (isset($_GET["id"])) {
        $id = trim($_GET["id"]);
        $query2 = "SELECT * FROM drivers_profile WHERE id = ?";
            ...
            <div class="container_for_table">
                <div class="form-container">
                    ...
                    <form method="post">
                        ...
                        <input type="text" name="first_name" placeholder="EMT ID" value="<?php echo htmlspecialchars($first_name); ?>" required />
                        <input type="text" name="lastname" placeholder="First Name" value="<?php echo htmlspecialchars($lastname); ?>" required />
                        <input type="text" name="phone_num" placeholder="Last Name" value="<?php echo htmlspecialchars($phone_num); ?>" required />
                        <input type="text" name="salary" placeholder="Phone Number" value="<?php echo htmlspecialchars($salary); ?>" required />
