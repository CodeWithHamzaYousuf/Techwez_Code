...
<body>
        ...
        <div class="main-content">
            <header>
                <div class="header-content">
                    ...
                    <img src="assest/rapidrescue" alt="" width="10%">
                    <form method="post">
                <button class="hover-button" type="submit" name="logOut">LOGOUT</button>
                <button class="hover-button" type="submit" name="logOut" style="margin-left:20px"><a href="add_recp_.php">ADD</a></button>
</form>
                </div>
            </header>
            <main>
 ...
 $conn = mysqli_connect("localhost", "root", "", "my_salon");
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td data-label="Gender">' . htmlspecialchars($data['cate']) . '</td>';
                    echo '<td data-label="City">' . htmlspecialchars($data['salary']) . '</td>';
                    ...
                    // <button class="hover-button" type="submit" name="logOut">LOGOUT</button>
                    echo '<td> <button class="hover-button" data-label="UPDATE"><a href="rec_update.php?id=' . htmlspecialchars($data['id']) . '">Upadate</a></button></td>';
                ...
                if (isset($_POST['delete'])) {
                    ...
                    $delete_query = "DELETE FROM  receptionist_table  WHERE id = ?";
