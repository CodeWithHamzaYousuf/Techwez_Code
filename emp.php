...
<body>
    ...
    <div class="overlay">
        ...
        <button class="hover-button"  onclick="window.location.href='emp_customer.php'">Check</button>
 ...
 $conn = mysqli_connect("localhost", "root", "", "my_salon");
                $query = "SELECT * FROM emps where name='meer'";
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td data-label="Email">' . htmlspecialchars($data['number']) . '</td>';
                    echo '<td data-label="Gender">' . htmlspecialchars($data['service']) . '</td>';
