...
<div class="dashboard">
        ...
        <div class="main-content">
            <header>
                <div class="header-content">
                    ...
                    <form method="post">
                <button class="hover-button" type="submit" name="logOut" style="margin-left:20px"><a href="Drivers_Profile_add.php">ADD</a></button>
</form>
                </div>
            </header>
            <main>
 ...
 $conn = mysqli_connect("localhost", "root", "", "rapid_rescue");
                $query = "SELECT * FROM drivers_profile";
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td data-label="Email">' . htmlspecialchars($data['phone_num']) . '</td>';
                    echo '<td data-label="Gender">' . htmlspecialchars($data['salary']) . '</td>';
                    ...
                    echo '<td> <button class="hover-button" data-label="UPDATE"><a href="update_emp.php?id=' . htmlspecialchars($data['id']) . '">Update</a></button></td>';
                ...
                if (isset($_POST['delete'])) {
                    ...
                    $delete_query = "DELETE FROM drivers_profile WHERE id = ?";
