...
$conn = mysqli_connect('localhost', 'root', '', 'rapid_rescue');
 if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO receptionist_table (name, email, phone, cate, salary) VALUES ('$name', '$email', '$phone', '$cate', '$salary')";
...
?>
    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <input type="text" placeholder="Enter Your Ambulance id" name="name"  required/>
            <input type="email" placeholder="Enter an Vehicle Number" name="email"  required/>
            <input type="int" placeholder="Enter Your Equipment Level" name="phone" required/>
            <input type="int" placeholder="Enter Your Current Stat" name="cate"  required/>
            <input type="int" placeholder="Enter a Driver name" name="salary"  required/>
